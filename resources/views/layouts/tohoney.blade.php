                            ...
                            {{-- <li><a href="register.html"> Login/Register </a></li> --}}
                             ...
                             <li>
                                ...
                                <ul class="dropdown_style">
                                    <li><a href="{{ route('home') }}">C-Dashbort</a></li>
                            ...
                            <li>
                                ...
                                <ul class="cart-wrap dropdown_style">
                                    ...
                                    @foreach ($carts as $cart)
                                        <li class="cart-items">
                                        <div class="cart-img">
                                            <img width="100" src="{{asset('uploads/product')}}/{{App\Models\Product::find($cart->product_id)->product_photo}}" alt="Not Fount">
                                        </div>
                                        <div class="cart-content">
                                            ...
                                            @php
                                                $subtotol += App\Models\Product::find($cart->product_id)->product_price * $cart->quantity;
                                            @endphp
